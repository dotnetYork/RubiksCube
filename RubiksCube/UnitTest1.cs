    ...
    public class Cube
    {
        ...
        public Cube RotateFront(Rotation direction)
        {
            ...
            else
            {
                ...
                var left = new Face(Left.TopLeft, Left.TopMiddle, Bottom.TopLeft, 
                    Left.MiddleLeft, Left.MiddleMiddle, Bottom.TopMiddle,
                    Left.BottomLeft, Left.BottomMiddle, Bottom.TopRight);
                var right = new Face(Top.BottomLeft, Right.TopMiddle, Right.TopRight,
                    Top.BottomMiddle, Right.MiddleMiddle, Right.MiddleRight,
                    Top.BottomRight, Right.BottomMiddle, Right.BottomRight);
                var top = Top.WithBottomRow(Left.BottomRight, Left.MiddleRight, Left.TopRight);
                var bottom = new Face(Right.BottomLeft, Right.MiddleLeft, Right.TopLeft,
                    Bottom.MiddleLeft, Bottom.MiddleMiddle, Bottom.MiddleRight,
                    Bottom.BottomLeft, Bottom.BottomMiddle, Bottom.BottomRight);
